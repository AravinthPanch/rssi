var sigGen1 = [
    ...
    {"x": 5.39, "y": 5.06, "room": "FT223", "rssi": [], "mean": 0, "variance": 0},
    {"x": 8.48, "y": 1.93, "room": "FT223", "rssi": [], "mean": 0, "variance": 0},
    {"x": 9.81, "y": 9.02, "room": "hollway_2nd", "rssi": [-62, -63, -64, -63, -63, -64, -64, -64, -64, -64, -63, -65, -65, -65, -64, -68, -64, -65, -65, -68], "mean": 64.35, "variance": 2.13},
    {"x": 11.57, "y": 1.89, "room": "FT224", "rssi": [], "mean": 0, "variance": 0},
    {"x": 11.57, "y": 5.06, "room": "FT224", "rssi": [], "mean": 0, "variance": 0},
    ...
    {"x": 17.56, "y": 5.06, "room": "FT225", "rssi": [], "mean": 0, "variance": 0},
...
var sigGen2 = [
    ...
    {"x": 30.28, "y": 1.67, "room": "FT227", "rssi": [], "mean": 0, "variance": 0}
];
...
function getSigGenRepeatability() {
    ...
    $.each(sigGen2, function (key, val) {
        sigGenStat[key].small02_mean = val.mean * -1;
    ...
    var template = "<tr><td>Measurement Points</td><td>X</td><td>Y</td><td>Small01</td><td>Small02</td><td>Repeatability</td></tr>";
    $('#sigGenTab').append(template)

    var i = 1;
    $.each(sigGenStat, function (key, val) {
        if (key <= 19) {
            template = '<tr><td>' + i + '</td><td>' + val.x
                + '</td><td>' + val.y + '</td><td>' + val.small01_variance + '</td><td>'
                + val.small02_variance + '</td><td>' + val.groupVariance
                + '</td></tr>';
            $('#sigGenTab').append(template)
            i++;
        }
    ...
    template = '<tr><td>' + 'Group Variance' + '</td><td>' + ' '
        + '</td><td>' + ' ' + '</td><td>' + sigGenStat[20].small01_mean_variance + '</td><td>'
        + sigGenStat[20].small02_mean_variance + '</td><td>' + sigGenStat[20].small_mean_variance
        + '</td></tr>';
    $('#sigGenTab').append(template)
